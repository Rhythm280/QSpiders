                ...
                <section className='courses'>
                    ...
                    <article className="course">
                        ...
                        <div className="courseFrames">
                            {(filteredCourses.length ? filteredCourses : courses).map((ele, i) => (
